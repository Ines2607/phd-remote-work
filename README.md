...
## Data Sources  
- Mobility signals (2019-2023) from Unicast provided by Habidatum (not publicly available)
- Israel Census 2022
- GTFS files  
...
- `data/` - Samples of datasets for demonstration used in the research (access restrictions may apply)    
- `results/` - Outputs and findings (graphs, tables, etc.)
- `conference_slides` - PDF with slides from the passed conferences
- geofunctions - notebooks with custom functions written for the project
...
- `the name of step-research` - intermediate step that aims to explore dependencies in the data, find outliers and establish rules before running `process` notebook. Mostly published without cleaning
